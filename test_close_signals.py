...
if __name__ == "__main__":
    # Тестовые цены для проверки закрытия
    test_prices = {
        "ETHUSDT": 4400,  # Достигнут TP3 (4380.32)
        "SOLUSDT": 210,   # Достигнут TP3 (204.83)
        "DOGEUSDT": 0.24, # Достигнут TP3 (0.23)
        "ADAUSDT": 0.75,  # Достигнут TP2 (0.73), но не TP3
        "AVAXUSDT": 23,   # Достигнут TP2 (22.50), но не TP3
    }
